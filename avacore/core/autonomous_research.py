    ...
    def _activate_finding(self, topic: ResearchTopic, answer: str) -> None:
        ...
        if hasattr(self.settings, "workspace_path"):
            run_workspace_cycle(
                ...
                decay_factor=getattr(self.settings, "workspace_decay_conversation", self.settings.workspace_decay_factor),
                general_decay_factor=getattr(self.settings, "workspace_decay_general", .92),
